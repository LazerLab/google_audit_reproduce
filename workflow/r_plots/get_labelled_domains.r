'''
This file categorize domains into six types. 
'''
...
house_domain_raw <- read_csv("../../data/house_analysis/house_domain_counts_unique.csv")

news_lists <- read_tsv("../../data/news_domains_ron.tsv")%>%
filter(news_is_news == 1)
news_lists2<- read_csv("../../data/us-news-domains.csv")
...
write.csv(house_domain_pre_handcode, "../../data/house_analysis/house_domain_pre_handcode_122024.csv", row.names = FALSE)
